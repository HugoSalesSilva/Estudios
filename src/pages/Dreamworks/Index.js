...
export default function App() {
   ...
   function navegarInfo(indiceInfo){
    ...
    <View style={styles.borda}>
      <ImageBackground source={require('../../../assets/DreamworksPainel.jpg')} style={styles.imgD42}>
        <View style={styles.brnArea2}>
            ...
            <View style={styles.botao2}  >
               <View style={styles.btnArea}>
                 <Text style={styles.btnTexto}>Dreamworks</Text>
            ...
            <Image source={require('../../../assets/COMO TREINAR O SEU DRAGÃO 3.jpg')} style={styles.imgD4}></Image>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Image source={require('../../../assets/Trolls.jpg')} style={styles.imgD4}></Image>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Image source={require('../../../assets/KUNG FU PANDA.jpg')} style={styles.imgD4}></Image>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Image source={require('../../../assets/MEGAMENTE.jpg')} style={styles.imgD4}></Image>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Image source={require('../../../assets/Madagascar (2005).jpg')} style={styles.imgD4}></Image>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Image source={require('../../../assets/The Croods (2013).jpg')} style={styles.imgD4}></Image>
